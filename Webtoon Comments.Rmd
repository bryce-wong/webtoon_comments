...
avg_num_comm = num_eps %>%
  summarize(mean_comments_per_ep = mean(number_of_comments),
            median_comments_per_ep = median(number_of_comments),
            sd_comments = sd(number_of_comments)) %>% 
  knitr::kable(digits = 3)

#stats of commentators
avg_user = num_users %>%
  summarize(mean_comments_per_user = mean(number_of_comments),
            median_comments_per_user = median(number_of_comments),
            sd_comments = sd(number_of_comments)) %>% 
  knitr::kable(digits = 3)
