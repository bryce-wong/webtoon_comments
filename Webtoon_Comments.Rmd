...
parse_comments = function(pagesrc){
  ...
  #add to dataframe
  data_frame(episode, comment_txt, username, likes, reply, likes_per_ep)
...
#write to a txt file
write.table(comment_df, file = "comments_april_24.txt", sep = ",", quote = TRUE, row.names = F)

#write to a csv
write.csv(comment_df,'comments_april_24.csv')
```
